...
export const Login = () => {
  const { signInWithDiscord, signInLoading, error } = useDiscordAuth()

  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <div className="mx-auto h-12 w-12 bg-linear-to-r from-green-500 to-blue-500 rounded-lg flex items-center justify-center mb-4">
            <span className="text-lg font-bold text-white">TB</span>
          </div>
          <h2 className="text-3xl font-bold text-gray-900">
            Welcome to Training Bureau
          </h2>
